      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          ...
          <div class="form-outline mb-4">
            ...
            <label class="form-label" for="form3Example3">Ingresar usuario</label>
          </div>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <a type="button" href="Formulario.html" class="btn btn-primary btn-lg"
